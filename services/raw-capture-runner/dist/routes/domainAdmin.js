...
exports.addDomainAdminRoutes = addDomainAdminRoutes;
function addDomainAdminRoutes(app, domainManager) {
    /**
     * POST /admin/domains
     *
     ...
     */
    app.get('/admin/domains/stats', async (req, res) => {
        try {
     ...
     */
    app.get('/admin/domains/cohorts', async (req, res) => {
        try {
     ...
     * }
     */
    app.put('/admin/domains/cohort', async (req, res) => {
        try {
    ...
    app.get('/admin/domains/docs', (req, res) => {
        res.json({
